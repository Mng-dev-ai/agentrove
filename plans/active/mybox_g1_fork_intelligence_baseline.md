...
- [ ] **Step 1: Create `screens.md` with top-level screen decisions**
...
- [ ] **Step 2: Create `features.yaml` using this exact record shape**
...
- [ ] **Step 3: Add inventory validator**
...
- [ ] **Step 2: Include the high-risk surfaces explicitly**
...
- [ ] **Step 3: Generate Markdown graph reports**
...
- [ ] **Step 5: Run graph generation and validation**
...
- [ ] **Step 1: Write harness registry contract**
...
- [ ] **Step 2: Write truth-label contract**
...
- [ ] **Step 3: Write local-first access contract**
...
- [ ] **Step 4: Write permission/mutation safety contract**
...
- [ ] **Step 2: Record visual baseline requirements**
...
- [ ] **Step 1: Decide whether to run Graphify**
...
- [ ] **Step 2: If run, store advisory output**
...
- [ ] **Step 1: Run generated map script**
